...
- `Story DoD Checklist`: `docs/_ai/checklists/story-dod-checklist.md`
...
5. **Pre-Completion DoD Review & Cleanup:**
    ...
    - <critical_rule>Meticulously verify story against each item in `docs/_ai/checklists/story-dod-checklist.md`.</critical_rule>
...
- /core-dump - ensure story tasks and notes are recorded as of now, and then run docs/_ai/tasks/core-dump.md
