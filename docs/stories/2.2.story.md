...
(Partially Copied from `docs/epic2-recovery-resolver-implementation.md#Story-2.2` and significantly enhanced)
...
(Derived from `docs/epic2-recovery-resolver-implementation.md#Story-2.2` and updated)
...
- **Integration Tests:** (AC5)
  ...
  - Refer to `docs/epic3-recovery-testing-and-integrity.md#Story-3.2` for more details on resolver integration test scenarios, and adapt them for the Gemini model.
