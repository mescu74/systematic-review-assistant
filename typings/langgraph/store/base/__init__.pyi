...
type NamespacePath = tuple[str | Literal["*"], ...]
type NamespaceMatchType = Literal["prefix", "suffix"]
...
type Op = GetOp | SearchOp | PutOp | ListNamespacesOp
type Result = Item | list[Item] | list[SearchItem] | list[tuple[str, ...]] | None
