...
"""
type EmbeddingsFunc = Callable[[Sequence[str]], list[list[float]]]
type AEmbeddingsFunc = Callable[[Sequence[str]], Awaitable[list[list[float]]]]
...
__all__ = ["AEmbeddingsFunc", "EmbeddingsFunc", "ensure_embeddings"]
